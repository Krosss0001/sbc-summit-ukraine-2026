...
export default async function CheckoutPage({ searchParams }: CheckoutPageProps) {
  ...
  return (
    <main className="checkout-shell form-shell px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl content-center gap-6 lg:grid-cols-[.8fr_1.2fr] lg:items-center lg:gap-8">
        <section>
          <Link href="/" className="nav-link text-[var(--color-accent)]">
            Назад до події
          </Link>
          <p className="eyebrow mt-8 lg:mt-10">Secure checkout</p>
          ...
          <div className="mt-6 grid gap-3 lg:mt-7">
            {tickets.map((ticket) => (
          ...
          <div className="notice mt-6 lg:mt-7">{paymentSecurityText}</div>
        </section>
